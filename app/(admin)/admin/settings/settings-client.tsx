  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        {/* TAB CONTENTS */}
        <div className="flex-1 bg-white rounded-2xl border border-[#FFE6D5] p-6 shadow-sm min-h-[400px]">
          ...
          {activeTab === "maintenance" && (
            <form action={mFormAction} className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div>
                <h3 className="text-lg font-bold text-[#E07A00] flex items-center gap-2">
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between p-4 border border-[#FFE6D5] bg-[#FFF5EE]/30 rounded-xl">
                  <div>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#E07A00] uppercase">Pesan Pemeliharaan</label>
                  <textarea
                    name="maintenance_message"
                    rows={3}
                    defaultValue={maintenanceSettings.maintenance_message}
                    className="w-full px-4 py-2.5 text-sm border border-[#FFE6D5] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF9100]"
                  />
                  <p className="text-[10px] text-slate-400">Pesan ini akan ditampilkan kepada UMKM saat mode pemeliharaan aktif.</p>
                </div>
              </div>

              <div className="pt-4 border-t border-[#FFE6D5] flex justify-end">
                <button type="submit" disabled={mPending} className="flex items-center gap-2 bg-[#FF9100] hover:bg-[#E07A00] text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all disabled:opacity-50">
          ...
          {activeTab === "access" && (
            <form action={aFormAction} className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="pt-4 border-t border-[#FFE6D5] flex justify-end">
                <button type="submit" disabled={aPending} className="flex items-center gap-2 bg-[#FF9100] hover:bg-[#E07A00] text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all disabled:opacity-50">
          ...
          {activeTab === "limits" && (
            <form action={lFormAction} className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#E07A00] uppercase">Limit Ekspor Harian per UMKM</label>
                  <input
                    type="number"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#E07A00] uppercase">Maks Upload Gambar (MB)</label>
                  <input
                    type="number"
                    name="max_upload_mb"
                    min={1}
              ...
              <div className="pt-4 border-t border-[#FFE6D5] flex justify-end">
                <button type="submit" disabled={lPending} className="flex items-center gap-2 bg-[#FF9100] hover:bg-[#E07A00] text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all disabled:opacity-50">
          ...
          {activeTab === "ai_magic" && (
            <form action={aiFormAction} className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="space-y-5">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#E07A00] uppercase">Model Groq AI</label>
                  {isLoadingModels ? (
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 text-sm border border-[#FFE6D5] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF9100] bg-white cursor-pointer"
                    >
                      {groqModels.length > 0 ? (
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#E07A00] uppercase">System Prompt (Instruksi)</label>
                  <textarea
                    name="ai_prompt"
                    rows={5}
                    defaultValue={aiSettings.ai_prompt}
                    className="w-full px-4 py-2.5 text-sm border border-[#FFE6D5] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF9100] resize-y min-h-[100px]"
                  />
                  <p className="text-[10px] text-slate-400">Gunakan tag <code className="bg-slate-100 px-1 py-0.5 rounded text-[#FF9100]">{"{keyword}"}</code> sebagai tempat kata kunci produk/jasa dari UMKM disisipkan.</p>
                </div>

                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#E07A00] uppercase">Max Tokens (Panjang Kata)</label>
                  <input
                    type="number"
                    name="ai_max_tokens"
                    min={10}
              ...
              <div className="pt-4 border-t border-[#FFE6D5] flex justify-end">
                <button type="submit" disabled={aiPending} className="flex items-center gap-2 bg-[#FF9100] hover:bg-[#E07A00] text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all disabled:opacity-50">
