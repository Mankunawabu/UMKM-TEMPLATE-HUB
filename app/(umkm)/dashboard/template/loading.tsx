  ...
  return (
    <div className="space-y-6 font-sans animate-in fade-in duration-500">
      ...
      <div className="relative">
        <div className="h-14 w-full bg-white border border-[#F7D6E6] rounded-2xl animate-pulse" />
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        <div className="w-full sm:w-64 shrink-0 space-y-2 hidden sm:block">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="h-11 w-full bg-white border border-[#F7D6E6] rounded-xl animate-pulse flex items-center px-4 gap-3">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <div key={i} className="border border-[#F7D6E6] rounded-2xl overflow-hidden bg-white flex flex-col">
                ...
                <div className="p-3.5 sm:p-4 border-t border-[#F7D6E6] flex-1 flex flex-col gap-2">
                  ...
                  <div className="h-9 w-full bg-[#FFF0F7] animate-pulse rounded-lg mt-3" />
                </div>
              </div>
            ))}
          </div>
