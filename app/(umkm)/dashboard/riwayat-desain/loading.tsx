    ...
    <div className="space-y-6 font-sans animate-in fade-in duration-500">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="relative w-full lg:max-w-md">
          <div className="h-10 w-full bg-white border border-[#FFE6D5] rounded-xl animate-pulse" />
        </div>

        {/* Filter Pills Skeleton */}
        <div className="flex flex-wrap gap-2 justify-start lg:justify-end">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-9 w-24 bg-white border border-[#FFE6D5] rounded-full animate-pulse" />
          ))}
        </div>
      </div>
          ...
          <div key={i} className="border border-[#FFE6D5] rounded-2xl overflow-hidden bg-white flex flex-col">
            ...
            <div className="p-3.5 border-t border-[#FFE6D5] flex-1 flex flex-col gap-2">
              ...
              <div className="mt-3.5 mt-auto">
                <div className="h-7 w-full bg-[#F3F4F6] animate-pulse rounded-lg border border-[#FFE6D5]" />
              </div>
            </div>
          </div>
        ))}
