  ...
  return (
    <div className="space-y-6 font-sans animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-64 shrink-0 flex flex-row md:flex-col gap-1 border-b md:border-b-0 md:border-r border-[#F7D6E6] pb-2 md:pb-0 md:pr-4 overflow-hidden">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className={`flex items-center gap-2.5 px-4 py-3 rounded-xl transition-all ${
                i === 1 ? "bg-[#C27BA0]" : "bg-white border border-transparent"
              }`}
            >
          ...
          <div className="space-y-6">
            ...
            <div className="mb-6 space-y-2">
              ...
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 rounded-2xl border-2 border-dashed border-[#F7D6E6] bg-slate-50 animate-pulse" />
