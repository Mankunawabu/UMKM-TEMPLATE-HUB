    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <div
          ...
          className={[
            "flex-1 h-12 px-4 rounded-xl border border-[#FFE6D5] hover:border-[#FF9100] bg-[#F3F4F6]/40 hover:bg-[#F3F4F6] cursor-pointer flex items-center gap-2.5 transition-all duration-200 select-none overflow-hidden text-xs font-semibold text-[#FF9100]",
            isDragOver ? "ring-2 ring-[#111827]/20 bg-[#FFF9F5]" : "",
            (disabled || uploading) ? "pointer-events-none opacity-70" : "",
          ].join(" ")}
        >
          {uploading ? (
            <Loader2 className="w-4.5 h-4.5 text-[#FF9100] animate-spin shrink-0" />
          ) : (
            <ImageIcon className="w-4.5 h-4.5 text-[#FF9100] shrink-0" />
          )}
        ...
        <div className="w-12 h-12 shrink-0 rounded-full border border-[#FFE6D5] bg-white flex items-center justify-center overflow-hidden shadow-xs relative">
          {preview ? (
            <img
               src={preview}
               alt="Logo Usaha"
            ...
            <div className="w-full h-full bg-[#FFF9F5] flex items-center justify-center text-[#FF9100]/40 rounded-full">
      ...
      <div className="flex items-center justify-between min-h-[18px]">
        ...
        {preview && (
          <button
            ...
            className="ml-auto flex items-center gap-1 text-[11px] text-[#FF9100] hover:text-[#FF9100] transition-colors"
          >
            <X className="w-3 h-3" />
            Hapus
          </button>
...
export default function OnboardingForm({
  ...
  return (
    <div className="w-full max-w-2xl p-8 bg-white/95 backdrop-blur-md rounded-[24px] shadow-[0_8px_30px_rgb(224,122,0,0.12)] border border-[#FFE6D5] relative">
      <div className="absolute top-4 right-4 text-[#FF9100] animate-bounce">
      ...
      {/* Global error */}
      {state?.error && (
        <div className="flex items-center gap-2 p-3 mb-6 text-sm text-[#FF9100] bg-[#FFF9F5] border border-[#FFE6D5] rounded-xl">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <Briefcase className="w-4 h-4 text-[#FF9100]" />
              </div>
              <input
                type="text"
                name="nama_usaha"
          ...
          <div>
            ...
            <div className="relative">
              <select
                name="category_id"
                disabled={isPending}
                className="w-full pl-3 pr-8 py-2.5 bg-[#FFF9F5] text-slate-700 border border-[#FFE6D5] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF9100] focus:border-transparent transition-all appearance-none cursor-pointer"
              >
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-[#FF9100]">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                <InstagramIcon className="w-4 h-4 text-[#FF9100]" />
              </div>
              <input
                type="text"
                name="instagram"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={2}
                className="w-full pl-9 pr-3 py-2 bg-[#FFF9F5] text-slate-800 placeholder-slate-400 border border-[#FFE6D5] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF9100] focus:border-transparent transition-all resize-none"
              />
            </div>
          </div>
        ...
        <div className="md:col-span-2 pt-4">
          <button
            type="submit"
            disabled={isPending}
            className="w-full flex items-center justify-center gap-2 py-4 bg-[#FF9100] hover:bg-[#E07A00] text-white font-bold rounded-xl text-sm transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-75 disabled:cursor-not-allowed active:scale-[0.99]"
          >
            {isPending ? (
