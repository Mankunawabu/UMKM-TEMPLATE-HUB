...
import { Lock, Loader2, AlertCircle, Check, X, ArrowLeft, Eye, EyeOff } from "lucide-react";
...
export default function ResetPasswordForm() {
  ...
  // Action state for reset password action
  ...
  const allRulesMet = hasMinLength && hasUppercase && hasLowercase && hasNumber && hasSpecialChar;
  const isFormValid = allRulesMet && isMatching;
        ...
        <div>
          ...
          {confirmPassword.length > 0 && (
            <div className="mt-1.5 flex items-center gap-1 text-[11px]">
              {isMatching ? (
                <span className="text-emerald-600 font-bold flex items-center gap-0.5 animate-fade-in">
