    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between p-4 bg-white border-b border-[#FFE6D5] text-[#E07A00] fixed top-0 left-0 right-0 z-40">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="font-bold text-sm tracking-tight">Admin KANCING</span>
        </div>
        <button
      ...
      >
          ...
          <div className="flex items-center justify-between p-6 border-b border-[#FFE6D5]">
            <div className="flex items-center gap-2">
              <img
                ...
                className="w-10 h-10 object-contain shrink-0"
              />
              <span className="font-bold text-md tracking-tight text-[#E07A00]">
                Admin KANCING
              </span>
            </div>
            <button
          ...
          <nav className="p-4 space-y-6 overflow-y-auto max-h-[calc(100vh-200px)]">
            {menuGroups.map((group, gIdx) => (
              <div key={gIdx} className="space-y-1">
                <span className="text-[10px] font-bold text-[#FF9100] uppercase tracking-wider block px-3 mb-1">
                  {group.title}
                </span>
        ...
        <div className="p-4 border-t border-[#FFE6D5] space-y-3 bg-white">
          <div className="flex items-center gap-3 px-3">
            <div className="w-8 h-8 rounded-full bg-[#FF9100] flex items-center justify-center text-white text-xs font-bold font-sans overflow-hidden">
              {profile?.avatar_url ? (
                <img
            ...
            <div className="truncate">
              ...
              <p className="text-[10px] text-[#FF9100]">Administrator</p>
            </div>
          </div>
          <button
      ...
      >
        ...
        <div className="p-4 border-t border-[#FFE6D5] space-y-3 bg-white">
          <div className="flex items-center gap-3 px-1">
            <div className="w-8 h-8 rounded-full bg-[#FF9100] flex items-center justify-center text-white text-xs font-bold font-sans overflow-hidden shrink-0">
              {profile?.avatar_url ? (
                <img
                  src={profile.avatar_url}
                  alt="Avatar"
